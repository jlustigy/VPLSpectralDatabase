...
from spectrum_class import Molecule, write_molecular_csv
...
molecules = [
    ...
    Molecule("O3", "O_3", [2.5, 0.55, 9.6]),
    Molecule("O2-O2", "O_2-O_2", [0.45, 0.48, 0.53, 0.57, 0.63, 1.06, 1.27]),
    ...
    Molecule("H2O", "H_2O", [0.65, 0.72, 0.82, 0.94, 1.12, 1.4, 1.85, 2.5, 6.3])
]
